class Gitveil < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/lucatescari/gitveil/releases/download/v1.0.0/gitveil-1.0.0-darwin-arm64.tar.gz"
      sha256 "fc868bf5876ab67ad376736f99194de02c1578dac18214e33de463176939515f"
    end
  end
